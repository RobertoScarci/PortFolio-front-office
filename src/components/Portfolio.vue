...
<template>
   ...
   <!-- start section nav -->
<nav id="main-nav" style="display: inline;">
  <div class="row">
    <div class="container">

      <div class="logo">
        <a href="/"><img src="../assets/img/images/logo.png" alt="logo"></a>
      </div>
                ...
                <div class="block-main mb-30">
                  <div class="content-main single-post padDiv">
                    ...
                    <p class="mb-30">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type
                      specimen book. </p>
                    <blockquote><p>
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae quo pariatur, ullam nihil voluptatem aliquam distinctio cumque nulla unde ut eos aut, commodi nesciunt nobis consequatur delectus provident porro excepturi.
                    </p></blockquote>
                  ...
                  <div class="content-main single-post padDiv">
                    ...
                    <div class="post-meta">
                      <ul class="list-unstyled mb-0">
                        ...
                        <li class="date">date:<a href="#">January 18, 2025</a></li>
                    ...
                    <p class="mb-30">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type
                      specimen book. </p>
                    <blockquote class=""><img src="../assets/img/images/avatar.jpg" alt=""></blockquote>
              ...
              <div class="col-md-12">
                <div class="block-main mb-30">
                  <div class="content-main single-post padDiv">
                    ...
                    <blockquote><img src="../assets/img/images/avatar.jpg" alt=""> <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. At doloribus minus magnam optio ipsa, qui quia voluptates aperiam voluptatem nostrum temporibus alias in dolorum repudiandae laudantium repellendus consequatur amet neque.</p></blockquote>
                    <p class="mb-30">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in
                      Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections
  ...
  <div id="footer" class="text-center">
    <div class="container">
      ...
      <div class="credits">
        ...
        -->
        Designed by <a href="https://bootstrapmade.com/">Roberto Scarci</a>
      </div>
...
nav {
  ...
  padding: 20px;
  display: none;
  -webkit-box-shadow: 0px 2px 93px 0px rgba(0, 0, 0, 0.18);
  -moz-box-shadow: 0px 2px 93px 0px rgba(0, 0, 0, 0.18);
  box-shadow: 0px 2px 93px 0px rgba(0, 0, 0, 0.18);
}
